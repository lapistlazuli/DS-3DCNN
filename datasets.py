...
DATASETS_CONFIG = {
        ...
        'Salinas': {
            'urls': ['https://www.ehu.eus/ccwintco/uploads/a/a3/Salinas_corrected.mat',
        ...
        'QUH': {
            'img': 'QUH_Tangdaowan.mat',
            'gt': 'QUH_Tangdaowan_GT.mat',
            'download': False,
            },
        'SDFC': {
            'img': 'fei2.mat',
...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'PaviaC':
        ...
        label_values = ["Undefined", "Brocoli_green_weeds_1", "Brocoli_green_weeds_2",
                        "Fallow", "Fallow_rough_plow",
                        "Fallow_smooth", "Stubble",
        ...
        #Load the image
        img = open_file(folder + 'Houston2013.mat')['x2013_IEEE_GRSS_DF_Contest_CASI']

        rgb_bands = (47, 31, 15)  # AVIRIS sensor

        gt = open_file(folder + 'Houston2013_gt.mat')['houston_gt']
        label_values = ["Undefined", "Healthy_grass", "Stressed_grass",
                        "Synthetic_grass", "Trees",
                        "Soil", "Water",
                        "Residential", "Commercial", "Road",
                        "Highway", "Railway", "Parking_Lot1", "Parking_Lot2","Tennis_Court","Running_Track"]

        ignored_labels = [0]
        
    elif dataset_name == 'QUH':
        #Load the image
        img = open_file(folder + 'QUH_Tangdaowan.mat')['Tangdaowan']

        rgb_bands = (47, 31, 15)  # AVIRIS sensor

        gt = open_file(folder + 'QUH_Tangdaowan_GT.mat')['TangdaowanGT']
        label_values = ["Undefined", "Rubber_track", "Flagging",
                        "Sandy", "Asphalt",
                        "Boardwalk", "Rocky_shallows",
                        "Grassland", "Bulrush", "Gravel_road",
                        "Ligustrum_vicaryi", "Coniferous_pine", "Spiraea", "Bare_soil","Buxus_sinica","Photinia_serrulata","Populus","Ulmus_pumila_L","Seawater"]

        ignored_labels = [0]
    elif dataset_name == 'SDFC':
        #Load the image
        img = open_file(folder + 'fei2.mat')['Y_whole_band']

        rgb_bands = (47, 31, 15)  # AVIRIS sensor

        gt = open_file(folder + 'FeiC_gt.mat')['patch_gt']
        label_values = ["Undefined", "Crops_1", "Bare_soil",
                        "Shrubs", "Playground_Track",
                        "Road", "Trees",
                        "Crops_2", "Shadow", "Concrete_Floor",
                        "Concrete_Roof", "Caigang_Watt_Roof", "Cars", "Asphalt_Roof","Grass","Glazed_Tile_Roof","Clay_Tile_Roof","Special_Material","Piazza_Area","White_Tile_Floor","Black_Tile_Floor"]
