...
def dfc2018_loader(folder):
        img2 = open_file(folder + 'Houston2018.mat')['Houston2018']
        img = img2[:,:,:-2]
        
        gt = open_file(folder + 'Houston2018_gt.mat')['Houston2018_gt_cubic']
        ...
        #gt = cv2.resize(gt, dsize=(img.shape[0],img.shape[1]), interpolation=cv2.INTER_CUBIC)
